          ...
          {plans.map((plan, index) => (
            <div
              ...
              className={`relative bg-card rounded-2xl border-2 p-6 lg:p-8 transition-all duration-300 hover:shadow-xl ${
                plan.popular
                  ? "border-teal-500 shadow-lg shadow-teal-500/10 scale-[1.02] lg:scale-105"
                  : "border-border hover:border-teal-300"
              }`}
            >
              {plan.popular && (
                <Badge className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-teal-500 to-emerald-500 text-white font-semibold px-4 py-1 hover:from-teal-600 hover:to-emerald-600">
                  Most Popular
                </Badge>
              )}
              ...
              <Button
                className={`w-full ${
                  plan.popular
                    ? "bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white font-semibold shadow-lg shadow-teal-500/25"
